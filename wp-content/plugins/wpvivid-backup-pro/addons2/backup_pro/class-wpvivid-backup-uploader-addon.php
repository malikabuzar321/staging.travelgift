    ...
    public function check_file_is_a_wpvivid_backup($file_name,&$backup_id)
    {
        if (WPvivid_backup_pro_function::is_wpvivid_backup($file_name))
        {
            if ($id =WPvivid_backup_pro_function::get_wpvivid_backup_id($file_name))
            {
                ...
                if(WPvivid_Backuplist::get_backup_by_id($id)===false && WPvivid_Backuplist::get_backup_by_id($white_label_id)===false)
                {
                    $backup_id=$id;
                    return true;
                }
        ...
        if(WPvivid_backup_pro_function::is_wpvivid_backup($file_name))
        {
            if($id=WPvivid_backup_pro_function::get_wpvivid_backup_id($file_name))
            {
                ...
                else
                {
                    ...
                    $remote_list=WPvivid_Backuplist::get_backuplist('wpvivid_remote_list');
                    foreach ($remote_list as $key=>$item)
                    {
                        if($id == $key)
                        {
