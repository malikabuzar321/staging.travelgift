    ...
    public function output_full_backup()
    {
        ...
        <div id="wpvivid_schedule_backup_deploy" style="display: none;">
            <table class="wp-list-table widefat plugin">
                ...
                <tr>
                    <th></th>
                    <th class="manage-column column-primary"><strong>Local Time </strong><a href="<?php esc_attr_e(apply_filters('wpvivid_get_admin_url', '').'options-general.php'); ?>">(Timezone Setting)</a></th>
