...
class WPvivid_pCloud_addon extends WPvivid_Remote_addon
{
        ...
        if($this->add_remote)
        {
            ...
            <script>
                ...
                function wpvivid_pcloud_auth()
                {
                    ...
                    var bdefault = '0';
                    jQuery("input:checkbox[option=pcloud]").each(function(){
                        ...
                        wpvivid_post_request_addon(ajax_data, function (data)
                        {
                            try
                            {
                                ...
                                if (jsonarray.result === 'success')
                                {
                                    ...
                                    location.href='<?php echo apply_filters('wpvivid_white_label_page_redirect', 'admin.php?page=wpvivid-remote', 'wpvivid-remote').'&action=wpvivid_pro_pcloud_drive&sub_page=cloud_storage_pcloud&result=success'; ?>';
                                }
    ...
    {
        ?>
        <div id="remote_storage_edit_pCloud" class="postbox storage-account-block remote-storage-edit" style="display:none; margin-bottom: 0;">
            <div style="padding: 0 10px 10px 0;">
                <strong>Enter Your pCloud Information</strong>
            </div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
