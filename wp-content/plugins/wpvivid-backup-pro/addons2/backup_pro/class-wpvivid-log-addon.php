...
class WPvivid_Log_addon
{
    ...
    public function my_test_admin_custom_styles()
    {
        ?>
        <style type="text/css">
            .column-wpvivid_date { width:20% }
            .column-wpvivid_log_type { width:15% }
            .column-wpvivid_log_file_name { width:40% }
            .column-wpvivid_log_action { width:10% }
            .column-wpvivid_download {width:15%}
        </style>
        <?php
    }
