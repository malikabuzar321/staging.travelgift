        ...
        <div class="wpvivid-welcome-panel wpvivid-clear-float">
            <div class="wpvivid-welcome-bar wpvivid-clear-float">
                ...
                <div class="wpvivid-welcome-bar-right">
                    <p style="text-align:right;"><span><span>Local Time:</span>
					    <span>
                            <?php
					    ...
					    <span class="dashicons dashicons-clock wpvivid-dashicons-blue"></span><span>
                        ...
                        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-backup'))
                        {
                            if($backup)
                            {
                                ...
                                echo '<div class="wpvivid-two-col wpvivid-dashboard-list">
                                                ...
                                                <span style="float: right;"><a href="'.$help_url.'">Learn more...</a></span><br>
                        ...
                        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-use-schedule'))
                        {
                            if($schedule)
                            {
                                ...
                                echo '<div class="wpvivid-two-col wpvivid-dashboard-list">
                                                ...
                                                <span style="float: right;"><a href="'.$help_url.'">Learn more...</a></span><br>
                                                Set up schedules for '.apply_filters('wpvivid_white_label_display', 'WPvivid').' tasks: general or incremental backups, image optimization and unused image cleaning.
                                            </div>';
                            }
                        }
                        ...
                        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-mange-backup'))
                        {
                            if($backup_list)
                            {
                                ...
                                echo '<div class="wpvivid-two-col wpvivid-dashboard-list">
                                                ...
                                                <a href="'.$url.'"><b>Backups & Restoration</b></a>
                                                <span style="float: right;"><a href="'.$help_url.'">Learn more...</a></span><br>
