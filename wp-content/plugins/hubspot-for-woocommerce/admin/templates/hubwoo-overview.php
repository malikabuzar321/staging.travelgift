	...
	<div class="pop_up_sub_wrap">
		<div class="hubwoo-disconnect-wrapper">		
			...
			<form class="hubwoo-disconnect-form">
				<label for='delete_meta'><input name="delete_meta" type="checkbox" name="hubwoo-acc-meta"><?php esc_html_e( 'Do you want to delete all your WooCommerce data from HubSpot? If yes, check the box.', 'hubspot-for-woocommerce' ); ?>
				</label>
			</form>
		...
		<div class="hubwoo-db__counter">
			<div class="hubwoo-db__row">
				<div class="hubwoo-db__counter-column">
					...
					<h6 class="hubwoo-db__counter-number"><a target="_blank" href=" <?php echo esc_url( 'https://app.hubspot.com/contacts/' . $portal_id . '/contacts/list/' ); ?> "><?php echo esc_textarea( $display_data['reg_users'] +  ( ! empty( $display_data['guest_users'] )? $display_data['guest_users'] : 0 ), 'hubspot-for-woocommerce' ); ?></a></h6>
			...
			<div class="hubwoo-db__strip hubwoo-db__strip--info">
				<div class="hubwoo-db__strip--infoCon">
					<div class="hubwoo-db__strip-row-content">
						<p>
							<?php 
								esc_html_e( 'Our HubSpot Onboarding Services offer a personalized strategy to streamline HubSpot implementations, migrations, integrations, and training.', 'hubspot-for-woocommerce' ); 
							?>
						</p>
					</div>
					<div class="mwb-heb-wlcm__btn-wrap">
