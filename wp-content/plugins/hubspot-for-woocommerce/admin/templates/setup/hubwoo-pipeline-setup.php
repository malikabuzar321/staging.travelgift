			...
			<form action="#" method="post" class="hubwoo_save_ecomm_mapping">
				<table class="hubwoo-deals-stages-conf-table form-table">
					...
					<tfoot>
						<tr>
							<td>
								<a href="javascript:void(0);" id = "hubwoo-save-pipeline" class="hubwoo-save-pipeline hubwoo-btn--primary"><?php esc_html_e( 'Save', 'hubspot-for-woocommerce' ); ?></a>	
							</td>
							<td>
								<button id="reset-deal-stages" class="hubwoo__btn hubwoo-btn--primary hubwoo-btn--dashboard"><?php esc_html_e( ' Reset to Default Mapping', 'hubspot-for-woocommerce' ); ?>
								</button>
							</td>
						</tr>
					</tfoot>
