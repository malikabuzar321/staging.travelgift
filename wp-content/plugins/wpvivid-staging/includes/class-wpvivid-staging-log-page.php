...
class WPvivid_Staging_Log_Page
{
    ...
    {
        $screen['menu_slug']='wpvividstg-log';
        $screen['screen_id']='wpvivid-staging_page_wpvividstg-log';
        $screen['is_top']=false;
        $screens[]=$screen;
        return $screens;
    }
    ...
    public function get_staging_menu($submenus, $parent_slug)
    {
        ...
        $submenu['menu_slug']=strtolower(sprintf('%s-log', apply_filters('wpvivid_white_label_slug', 'wpvividstg')));//'wpvividstg-log';
        $submenu['index']=4;
        ...
        <div class="postbox quickbackup-addon">
            <div>
                ...
                <div class="wpvivid-element-space-bottom">
                    <div class="wpvivid-text-space-bottom" style="margin-bottom: 0;">This page displays the logs of creating staging sites, updating staging sites, and pushing staging to live.</div>
                </div>
    ...
    {
        ?>
        <div class="postbox restore_log" id="wpvivid_read_log_content" style="word-break: break-all;word-wrap: break-word;">
